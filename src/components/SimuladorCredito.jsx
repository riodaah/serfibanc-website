...
const SimuladorCredito = ({ tipo = 'PYME', montoMin, montoMax, maxCuotas, tasaInteres }) => {
  const [formData, setFormData] = useState({
    monto: config.simulacion.opcionesMonto[2], // 20M por defecto
    cuotas: 36,
    ingresoMensual: '',
    antiguedad: '',
        ...
        <form onSubmit={handleSimular} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              {config.simulacion.opcionesMonto.map((monto) => (
          ...
          <div>
            ...
            >
              <option value="">Seleccionar valor</option>
              {config.simulacion.opcionesCuotas.map((cuota) => (
